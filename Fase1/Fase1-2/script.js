...
function drawHUD(player,level){
  ...
  ctx.fillStyle='#c0c8d8';ctx.font='bold 15px "Courier New"';ctx.textAlign='right';ctx.fillText('◆ '+player.score,W-14,24);ctx.textAlign='left';
  ...
  ctx.fillStyle='rgba(210,185,80,.7)';ctx.font='12px "Courier New"';ctx.textAlign='center';ctx.fillText(hintText,W/2,H-10);ctx.textAlign='left';
